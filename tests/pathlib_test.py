...
class TestNameResolution(unittest.TestCase):
    ...
    def test_resolve_name(self):
        self.assertEquals(pathlib.resolve_name(self.root, 'b'), 'b')
        self.assertEquals(pathlib.resolve_name(self.root, 'a'), 'a.1')
        self.assertEquals(pathlib.resolve_name(self.root, 'a.mp3'), 'a.1.mp3')
