...
"""
This is the dantalian package, which contains all the code for the dantalian
script, as well as various modules and packages that can be imported and used
separately.
"""
